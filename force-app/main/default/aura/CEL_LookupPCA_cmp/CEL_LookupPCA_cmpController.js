({
    buscarCampos : function(component, event, helper) {
        ...
        var action = component.get("c.lupasTipificacionPCA");
    ...
    ocultarMenu: function(component, event, helper){
        ...
        var varLst2 = component.get("v.ListCamposLupa");
   ...
   guardarCampos: function(component,event,helper){
        ...
        var actionGuardar = component.get("c.guardarPCA");
